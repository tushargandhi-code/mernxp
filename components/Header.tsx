      ...
      <div className="container mx-auto flex flex-wrap p-5 flex-row items-center justify-between">
        ...
        >
          <ul className="flex flex-col md:flex-row md:items-center md:space-x-6 text-center md:text-left">
            <li><Link href="/politics" className="hover:text-orange-500 px-2 py-2 md:py-0">POLITICS</Link></li>
            <li><Link href="/money" className="hover:text-orange-500 px-2 py-2 md:py-0">MONEY</Link></li>
            <li><Link href="/usnews" className="hover:text-orange-500 px-2 py-2 md:py-0">US-NEWS</Link></li>
            <li><Link href="/entertainment" className="hover:text-orange-500 px-2 py-2 md:py-0">ENTERTAINMENT</Link></li>
          </ul>
        </nav>
