...
const Fashion = () => {
  return (
    ...
    <div className='mt-40 text-black text-center mx-5 flex flex-col justify-center'>
        ...
        redefining how we approach everyday wear. Whether it's bold statement pieces or minimalist elegance, 
        ...
        <img className='w-full  mt-3' src='https://images.pexels.com/photos/325876/pexels-photo-325876.jpeg?cs=srgb&dl=pexels-pixabay-325876.jpg&fm=jpg'/>
