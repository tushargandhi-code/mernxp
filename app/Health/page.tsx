...
const Health = () => {
  return (
    ...
    <div className='mt-40 text-black text-center mx-5 flex flex-col justify-center'>
        ...
        <Image alt='hi' className='w-full  mt-3' src='https://images.unsplash.com/photo-1532938911079-1b06ac7ceec7?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8aGVhbHRofGVufDB8fDB8fHww'/>
