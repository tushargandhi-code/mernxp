...
const Grooming = () => {
  return (
    ...
    <div className='mt-40 text-black text-center mx-5 flex flex-col justify-center'>
        ...
        <img className='w-full  mt-3' src='https://www.thegroomingclinic.com/cdn/shop/collections/anthony_skincare_for_men_987860cb-06be-4d9f-a188-186c6586b54d.jpg?v=1665063115'/>
