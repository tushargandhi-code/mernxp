...
const Terms = () => {
  return (
    ...
    <div className="max-w-4xl mt-20 mx-auto p-6 text-gray-700">
      ...
      <p className="mb-4">Welcome to MensXP! By accessing and using our website, you agree to comply with the following terms and conditions.</p>
      ...
      <p className="mb-4">All content on this website, including text, images, and logos, is owned by MensXP or its licensors and is protected by intellectual property laws.</p>
      ...
      <p className="mb-4">MensXP does not guarantee the accuracy, reliability, or completeness of the content. Use the information at your own risk.</p>
      ...
      <p className="mb-4">If you have any questions about these terms, please contact us at support@mensxp.com.</p>
    </div>
